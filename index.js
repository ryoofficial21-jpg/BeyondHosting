...
client.on(Events.MessageCreate, async (message) => {
    ...
    const content = message.content;
     ...
     function createUserLogEmbed(member, title, color = "Blue") {
...
const logEmbed = new EmbedBuilder()
    .setTitle("📝 Whitelist Request Created")
    .setColor("Yellow")
    ...
    .addFields(
        ...
        { name: "Vouched", value: vouched, inline: false },
...
const logEmbed = new EmbedBuilder()
    ...
    .addFields(
        { name: "User", value: `${target.user} (\`${target.id}\`)`, inline: false },
        { name: "Approved By", value: `${interaction.user}`, inline: true },
        { name: "Role Given", value: `<@&${config.serverRoles.citizen}>`, inline: true }
    )
    .setTimestamp();
...
const logEmbed = new EmbedBuilder()
    .setTitle(roleType === "role" ? "🎭 Role Added" : "🚫 Role Removed")
    .setColor("Green")
    .setThumbnail(member.user.displayAvatarURL({ dynamic: true }))
    .addFields(
        { name: "User", value: `${member.user} (\`${member.id}\`)`, inline: false },
        { name: "Role", value: `<@&${roleId}>`, inline: true },
        { name: "Action By", value: `${interaction.user}`, inline: true }
    )
    .setTimestamp();
